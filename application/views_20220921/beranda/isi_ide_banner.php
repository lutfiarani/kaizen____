...
.contact_section {
   ...
   background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(http://localhost/kaizen__/template/login/images/Slide_Submit_Idea.png);
   height: 50%;
      ...
      <form>
        <div class="row">
          ...
          <div class="col-md-5 contact_form-container">
            <textarea rows="15" cols="80" placeholder="      Isi ide Anda di sini" id="ide" nama="ide" ></textarea>
        ...
        <br>
        <!-- <div class="col-sm-12"> -->
        <div class="card text-black mb-3" style="max-width: 60rem; background-color: rgba(255,255,153); border-radius: 40px;">
          <div class="card-body">
