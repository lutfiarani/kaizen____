...
<div id="fullpage">
   ...
   <div class="desktop-display section active"  id="section0">
            ...
            <div class="carousel-inner" style=" margin-top: 63px">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block" style="margin-bottom: 20vh">
                        ...
                        <div class="card text-white bg-secondary  mb-3 opacity-50" style="align:center;margin-right:500px; width: 75vw; margin: 0 auto; float: none; margin-top: 60vh; border:1px; height: 45%;" align="center">
...
<div class="mobile-display section active" id="section0">
    <section class=" slider_section position-relative" id="section0" >
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="5000" style="height: auto;" >
            ...
            <div class="carousel-inner" style=" margin-top: 0px">
                ...
                <div class="card bg-light mb-3" style="width: 75%;padding-top: 30px; margin: 0 auto; float: none; margin-top: 50vh; border:1px; height: 25%; align=center">
                    <div class="card-body">
                        <div class="row">
