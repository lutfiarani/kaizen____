            ...
            <div class="carousel-inner" style="  margin-top: 63px; ">
                <div class="carousel-item gambar active">
                    ...
                    <div class="carousel-caption d-none d-md-block" >
                        <div id="cobalah">
                            <div class="card text-white bg-secondary" style="margin-top:10vh" >
                ...
                <div class="card bg-light mb-3" style="width: 75%;padding-top: 30px; margin: 0 auto; float: none; margin-top: 70vh; border:1px; height: auto; align:center" >
