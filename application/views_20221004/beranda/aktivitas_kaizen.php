        ...
        <div class="layout_padding2-top">
          ...
          <div class="row" style="background: #e0e0e0;">
            ...
            <div class="col-md-3" style="padding: 0px">
              ...
              <div class="img-box">
                <img src="<?php echo base_url();?>/template/images/<?php echo $aktivitas_kaizen[6]['IMG']; ?>" alt="">
            ...
            <div class="col-md-3" style="padding: 0px">
              ...
              <div class="img-box">
                <img src="<?php echo base_url();?>/template/images/<?php echo $aktivitas_kaizen[7]['IMG']; ?>" alt="">
