...
<html lang="en">
  <head>
	...
	<body class="img js-fullheight" style="background-image: url('<?php echo base_url();?>template/login/images/bg.png');">
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form method="POST" action="<?php echo site_url('C_login/masuk/');?>" class="signin-form">
