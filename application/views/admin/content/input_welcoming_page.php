              ...
              success:function(data)
              {
                ...
                for(i=0; i<data.length; i++){
                  datas = data[i];
                    ...
                    '</td>';
                    if(param=='aktivitas_kaizen'){
                        html += '<td scope="col" class="update_data" data-id="'+datas.IMG_ID+'" data-column="IMG_TITLE" contenteditable>'+datas.IMG_TITLE+'</td>'
                    }else{
                        html +='';
                    }
                    html +='<td scope="col" class="update_data" data-id="'+datas.IMG_ID+'" data-column="IMG_DESC" contenteditable>'+datas.IMG_DESC+'</td>'+
