...
<div class="desktop-display section">
  <section class="news_section layout_padding img" style="background-repeat-y: no-repeat;">
      <div class="containers" style="margin-top: 35vh; padding:50px">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="box">
              ...
              <div class="detail-box" style="margin-top: 35vh; padding:10px">
                <h2>
                  <b>Tentang Kami</b>
                </h2>
...
<div class="mobile-display section">
  ...
  <div class="containers" style="padding:15px; height: 75%;">
        
        <div class="row">
          <!-- <div class="col-md-3"> -->
        
              <div class="detail-box" style="margin-top: 0; padding:10px;">
                <h2>
                  <b>Tentang Kami</b>
                </h2>
                <p style="font-size: 20px;">
          ...
          <div class="col-md-8">
            <div class="card-deck">
                <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" data-interval="3000" style="width: 100%; height:75%" >
                  <ol class="carousel-indicators" style="margin-bottom: auto">
                      <li data-target="#carouselExampleIndicators1" data-slide-to="0" class="active"></li>
                      <li data-target="#carouselExampleIndicators1" data-slide-to="1"></li>
                      <li data-target="#carouselExampleIndicators1" data-slide-to="2"></li>
                  </ol>
                <div class="carousel-inner" style=" margin-top: 0px; height: 75%">
